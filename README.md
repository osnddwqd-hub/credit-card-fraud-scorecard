...
| Median score | **364.0** |
| Maximum score | **561** |
| Transactions scoring ≤500 | **99.66%** (85,156) |
| Fraud captured at score ≤500 | **100.00%** (148/148) |
...
|---|---:|---:|---:|
| (-1, 200] | 5,570 | 132 | 2.37% |
| (200, 300] | 16,335 | 7 | 0.04% |
| (300, 400] | 39,524 | 8 | 0.02% |
| (400, 500] | 23,727 | 1 | 0.00% |
| (500, 600] | 287 | 0 | 0.00% |
| (600, 700] | 0 | 0 | — |
| (700, 800] | 0 | 0 | — |
| (800, 900] | 0 | 0 | — |
...
**99.66%** of test transactions and capture
**100.00%** of the fraud cases in the test set.
